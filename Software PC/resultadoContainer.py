...
class ResultadoContainer(EmptyContainer):
    ...
    def __init__(self, father, dir):
        ...
        Label(frameDados, text="Tempo do fim do exame até cursor:", font=("Arial", 9)).grid(row=24, column=0, columnspan=3, padx=5, sticky=W)
